...
class DouyinTiktokScraper:
    ...
    async def tiktok_fetch_user_post(self, username: str):
        option_data = {
            "quiet": True,
            "extract_flat": True,
            "skip_download": True,
        ...
        #https://www.tiktok.com/@funxefew
        tab_url = f"https://www.tiktok.com/@{username}"
        video_urls = []
        try:
            with YoutubeDL(option_data) as ydl:
...
#     )
#     asyncio.run(scraper.douyin_fetch_user_post_videos(sec_user_id="MS4wLjABAAAA2-p9ZRDxFZ_sr9dghddoM6wcJpUM4qOaVAcXekrr4x4", max_cursor=0, count=50))  
